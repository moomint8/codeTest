...
문제
수현이는 4차 산업혁명 시대에 살고 있는 중학생이다. 코로나 19로 인해, 수현이는 버추얼 학교로 버추얼 출석해 버추얼 강의를 듣고 있다. 수현이의
...
4차 산업혁명 시대에 숙제나 하고 앉아있는 것보다 버추얼 친구들을 만나러 가는 게 더 가치있는 일이라고 생각했던 수현이는 이런 연립방정식을 풀
시간이 없었다. 다행히도, 버추얼 강의의 숙제 제출은 인터넷 창의 빈 칸에 수들을 입력하는 식이다. 각 칸에는
...
public class MathIsNonFaceToFaceLecture {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int lcm = (a * d) / getGCD(a, d);

        if (a != 0 && d != 0) {
            y = ((c * lcm / a) - (f * lcm / d)) / ((b * lcm / a) - (e * lcm / d));
            x = (c - (b * y)) / a;
        } else if (a == 0) {
            y = c / b;
            x = (f - (e * y)) / d;
